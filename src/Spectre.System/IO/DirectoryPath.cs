...
namespace Spectre.System.IO
{
    ...
    public sealed class DirectoryPath : Path
    {
        ...
        public FilePath GetFilePath(FilePath path)
        {
            ...
            var combinedPath = global::System.IO.Path.Combine(FullPath, path.GetFilename().FullPath);
        ...
        public FilePath CombineWithFilePath(FilePath path)
        {
            ...
            var combinedPath = global::System.IO.Path.Combine(FullPath, path.FullPath);
            return new FilePath(combinedPath);
        }
